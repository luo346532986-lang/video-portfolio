...
*/
const projects = [
  { title: "把风夹在身边", category: "AIGC", year: "2026", duration: "01:12", cover: "covers/wind-film.jpg?v=20260720-cover2", src: "videos/wind-film.mp4", problem: "产品内容齐全，但品牌缺少让人停留的情绪记忆。", deliverable: "品牌短片 / 氛围影像 / 社媒内容", description: "以节奏、留白和情绪画面补足品牌表达，让内容不只说明产品，也建立被记住的理由。" },
  { title: "多米拉 S1 烤箱", category: "实拍", year: "2026", duration: "01:11", cover: "covers/domira-oven.jpg?v=20260720-cover2", src: "videos/domira-oven.mp4", problem: "专业设备参数多，用户难在短时间内理解产品价值。", deliverable: "主图视频 / 功能节奏剪辑 / 详情页素材", description: "以产品结构、操作细节与真实使用场景建立认知，让核心卖点在第一屏就被看见。" },
  ...
  { title: "老面醒发箱", category: "AIGC", year: "2026", duration: "00:46", cover: "covers/proofing-cabinet.jpg?v=20260720-cover2", src: "videos/proofing-cabinet.mp4", problem: "商用设备应用复杂，潜在客户缺少使用场景联想。", deliverable: "场景演示 / 操作流程 / 功能卖点素材", description: "以真实工序串联设备功能，降低理解门槛，并把专业能力转化为可信赖的使用体验。" },
