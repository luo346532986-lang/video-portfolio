...
const projects = [
  ...
  { title: "AI 骑行智能眼镜概念片", category: "AIGC", year: "2026", duration: "00:52", cover: "covers/ai-cycling-glasses.jpg?v=20260720-new2", src: "videos/ai-cycling-glasses.mp4", problem: "智能硬件的交互价值难以通过静态画面被快速理解。", deliverable: "AIGC 概念短片 / 场景演示 / 产品交互视觉", description: "将骑行场景、HUD 导航与语音交互串联为连续体验，让抽象功能变成可感知的使用画面。" },
  { title: "Rich Luck 商厨品牌片", category: "AIGC", year: "2026", duration: "00:37", cover: "covers/richluck-brand-film.jpg?v=20260720-new2", src: "videos/richluck-brand-film.mp4", problem: "商厨品牌需要在短时间内建立规模感、制造力与服务信任。", deliverable: "AIGC 品牌片 / 工厂展示 / 客户服务场景", description: "从展厅、生产与服务三条线建立品牌叙事，让设备能力与企业可信度同时被看见。" },
];
